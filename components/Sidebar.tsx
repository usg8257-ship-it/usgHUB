...
const NAV = [
  ...
  { href: '/employees',  label: 'Employees',    icon: Users,        roles: ['SUPER_ADMIN','HR_OFFICER','STAFF'] },
  { href: '/onboarding', label: 'Onboarding',   icon: UserPlus,     roles: ['SUPER_ADMIN','HR_OFFICER','STAFF'] },
  { href: '/tracker',    label: '20DS Tracker', icon: ClipboardList,roles: ['SUPER_ADMIN','HR_OFFICER'] },
  { href: '/hr-docs',    label: 'HR Docs',      icon: FileText,     roles: ['SUPER_ADMIN','HR_OFFICER'] },
